...
cp terraform-provider-zitadeltools $HOME/.terraform.d/plugins/registry.socrate.fr/socrate-tech/zitadeltools/1.0.0/darwin_arm64/terraform-provider-zitadeltools_v1.0.0
cd $PWD/examples
# export TF_LOG=info
